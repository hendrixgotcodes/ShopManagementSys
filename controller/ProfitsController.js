...
thProfit.addEventListener("click", ()=>{

    thProfit.addEventListener("click",()=>{

        const tableEl = thProfit.parentElement.parentElement.parentElement;
        const headerIndex = Array.prototype.indexOf.call(thProfit.parentElement.parentElement.children, thProfit);
        const isAsc = thProfit.classList.contains("th-sort-asc");
